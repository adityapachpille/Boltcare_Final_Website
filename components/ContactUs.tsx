          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li>
                  <strong>Phone:</strong> +91 7559337386
                </li>
                <li>
                  <strong>Email:</strong>{' '}
                  <a href="mailto:boltcarepharma@gmail.com" className="text-blue-600">
            ...
            <div>
              ...
              <div className="flex space-x-4 text-blue-600 mt-2 text-xl">
                ...
                <a href="https://wa.me/7559337386" aria-label="WhatsApp" target="_blank">
                  <FaWhatsapp />
                </a>
                <a
                  href="https://www.instagram.com/boltcare_pharma/"
